...
%[958.828151406076,517.112206521841]
...
T1 = readtable('D:\CV Project\Final Submission\Dataset/frame_50_N_points_new.csv');
T1 = table2array(T1);
X = T1(:,2);
Y = T1(:,3);
...
Z_mean = mean(Z);
fprintf("The mean depth of the box is : %f mm", Z_mean)
